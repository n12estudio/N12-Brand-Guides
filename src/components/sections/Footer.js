                    ...
                    <Row sm="1" md="1" className="footern12">
                        <Col sm="12" md="12" className="zonacontac">
                            <Row sm="1" md="1">
                                ...
                                <Col sm="12" md="12" className="btnscontac">
                                    <a href="https://www.facebook.com/n12estudio"><FontAwesomeIcon icon={faEnvelope} className="btnemail"/></a>
                                    <a href="https://www.facebook.com/n12estudio"><FontAwesomeIcon icon={faWhatsapp} className="btnwhatsapp"/></a>
                                </Col>
                            </Row>
                        </Col>
                        <Col sm="12" md="12" className="zonainfo">
                            <Row sm="3" md="3">
                                ...
                                <Col sm="10" md="10">
                                    <Row xs="2" sm="2" md="2">
                                        <Col sm="6" md="6" className="webn12"><p>www.n12.mx</p></Col>
                                        <Col sm="6" md="6" className="n12est"><p>N12 Estudio® 2020</p></Col>
                                        <Col xs="12" sm="12" md="12"><p className="Footertxt">
                        ...
                        <Col sm="12" md="12" className="LogoFooter">
                            <a href="https://www.facebook.com/n12estudio"><img src={LogoFooter} href="#" alt="logotipo" /></a>
                        </Col>
                    </Row>
                </Container>
            </footer>
